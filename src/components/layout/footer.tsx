...
export default function Footer() {
  return <footer className="site-footer">
    <div className="site-container footer-main">
      <div className="footer-brand"><Link href="/home" aria-label="Campus Innovate home"><BrandLogo /></Link><p>Building meaningful programs, efficient systems, and learning experiences that develop future leaders.</p></div>
