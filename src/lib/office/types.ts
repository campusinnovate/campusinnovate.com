...
export type OfficeDocument = { id: string; title: string; creator_id: string; source_path: string; source_hash: string; output_path: string | null; output_hash: string | null; page_count: number; status: 'pending' | 'completed' | 'cancelled'; credential: string; created_at: string; completed_at: string | null; signers: Signer[] };
