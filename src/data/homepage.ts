...
export const clientMarks = [
  ...
  { name: 'Universitas Bina Niaga', logo: '/assets/site-2026/logos/unbin-drive.png' },
  { name: 'Student Entrepreneur Expo', logo: '/assets/site-2026/logos/student-expo-drive.png' },
  { name: 'Career Development and Assessment IPB', logo: '/assets/site-2026/logos/cda-drive.jpg' },
  { name: 'LP2AI IPB', logo: '/assets/site-2026/logos/lp2ai-drive.png' },
  { name: 'Wirausaha Merdeka IPB', logo: '/assets/site-2026/logos/wmk-drive.png' },
  { name: 'DPKKHA IPB', logo: '/assets/site-2026/logos/dpkkha-drive.png' },
  { name: 'University College Agroscience Malaysia', logo: '/assets/site-2026/logos/ucam-drive.png' },
  { name: 'DPMA IPB', logo: '/assets/site-2026/logos/dpma-drive.png' },
  { name: 'PUSTARHUT', logo: '/assets/site-2026/logos/pustarhut-drive.jpg' },
  { name: 'VK Penta', logo: '/assets/site-2026/logos/vk-penta-drive.png' },
  { name: 'Trendy AI', logo: '/assets/site-2026/logos/trendy-drive.png' },
] as const;
...
export const workfolioProjects: readonly WorkfolioProject[] = [
  {
    ...
    gallery: ['/images/workfolio/wunproq/gallery-01.webp', '/images/workfolio/wunproq/gallery-02.webp', '/images/workfolio/wunproq/gallery-03.webp', '/images/workfolio/wunproq/gallery-04.webp'],
    logoSurface: 'light',
  ...
  },
  {
    ...
    client: 'DPMA IPB University',
    year: '2026',
    logo: '/images/workfolio/dpma-ipb/logo-drive.png',
