...
export default function ContentPlanPage(){
  ...
  if(state==='denied')return <main className="rk-dashboard-foundation"><section className="rk-access-denied"><h1>Content Plan belum tersedia</h1><p>Hubungi administrator untuk mengaktifkan akses.</p><Link href="/ruang-kawan/dashboard/">Kembali</Link></section></main>;
  ...
  return <main className="rk-content-foundation"><section className="rk-content-shell">
    <nav className="rk-content-nav"><Link href="/ruang-kawan/dashboard/"><FiArrowLeft/> Dashboard</Link><button onClick={()=>void load()}><FiRefreshCw/> Muat ulang</button></nav>
