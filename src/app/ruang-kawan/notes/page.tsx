...
import { FiArchive, FiArrowLeft, FiCheck, FiEdit3, FiPlus, FiSearch, FiStar, FiTrash2, FiX } from 'react-icons/fi';
...
export default function NotesPage(){
  ...
  async function load(){
    ...
    if(result.error)setError('Coret-coret belum dapat dimuat.'); else setNotes((result.data??[]) as Note[]); setState('ready');
  }
  useEffect(()=>{void load();},[]);
